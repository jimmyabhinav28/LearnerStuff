...
//	}
	...
	public static Table3DTO convertTable3EntityToTable3DTO(Table3Entity entity,Table2Entity table2Entity)
	{
		Table3DTO dto=new Table3DTO();
		dto.setAttribute1(entity.getAttribute1());
		dto.setId(entity.getId());
//		dto.setTable2dto(Table2Service.convertTable2EntityToTable2DTO(table2Entity));
		return dto;
	}
