...
public class Table2Service {
	...
	public Table2DTO getById(Long id) {
		Table2Entity entity=table2dao.getById(id);
		Table3Entity table3Entity=entity.getTable3();
		Table3DTO table3DTO=Table3Service.convertTable3EntityToTable3DTO(table3Entity,false);
		return convertTable2EntityToTable2DTO(entity,table3DTO);
	}
	...
	public static Table2DTO convertTable2EntityToTable2DTO(Table2Entity entity) {
		...
		if (entity.getTable3() != null) {
			dto.setTable3dto(
					Table3Service.convertTable3EntityToTable3DTO(entity.getTable3(), false));
